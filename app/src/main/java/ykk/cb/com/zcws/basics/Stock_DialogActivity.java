...
import ykk.cb.com.zcws.basics.adapter.Stock_DialogAdapter;
 ...
 * 选择仓库dialog
 */
public class Stock_DialogActivity extends BaseDialogActivity implements XRecyclerView.LoadingListener {
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (m != null) {
                ...
                switch (msg.what) {
                    case SUCC1: // 成功
                        List<Stock> list = JsonUtil.strToList2((String) msg.obj, Stock.class);
