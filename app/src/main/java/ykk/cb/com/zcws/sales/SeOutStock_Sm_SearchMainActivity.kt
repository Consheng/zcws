...
import kotlinx.android.synthetic.main.sal_seoutstock_sm_search_main.*

/**
 * 发货状态查询
 */
class SeOutStock_Sm_SearchMainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "SeOutStock_Sm_SearchMainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null

    val fragment1 = SeOutSotck_Sm_SearchFragment()
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.sal_seoutstock_sm_search_main;
    }
