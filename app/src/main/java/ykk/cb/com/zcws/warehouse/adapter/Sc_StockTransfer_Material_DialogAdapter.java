...
public class Sc_StockTransfer_Material_DialogAdapter extends BaseArrayRecyclerAdapter<Inventory_K3> {
    ...
    public Sc_StockTransfer_Material_DialogAdapter(Activity context, List<Inventory_K3> datas) {
        super(datas);
